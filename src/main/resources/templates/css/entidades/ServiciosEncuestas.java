...
public class ServiciosEncuestas extends MetodosDB<Encuesta> {
    private static entidades.ServiciosEncuestas instancia;

    private ServiciosEncuestas(){super(Encuesta.class);}

    public static entidades.ServiciosEncuestas getInstancia(){
        if(instancia==null){
            instancia = new entidades.ServiciosEncuestas();
        }
        return instancia;
    }

    public boolean instanciarDB(){
        ServiciosSectores.getInstancia().crearSectores("Altamira\n" +
                "Arenoso\n" +
                "Azua de Compostela\n" +
                "Bajos de Haina\n" +
                "Baní\n" +
